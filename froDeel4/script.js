...
var part4 = {
    ...
    instruction1: function () {
        ...
        var student = {name: "Stan Haakman", group: "MD2A", lessons: "FRO,BAP en PROJ"};
        var result = "De student " + student.name + " zit in groep " + student.group + " en zijn eerste les is " + student.lessons[0] + student.lessons[1] + student.lessons[2];
